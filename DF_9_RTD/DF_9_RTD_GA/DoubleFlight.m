...
clear
clc
global map source goal noOfFlights noOfDimensions splineSmoothing goalBefore
...
%         200 350;
%         200 400;
%         200 450;]; % source position in X, Y Z format
% goalBefore=[100 100 100;
%       100 250 100;
%       100 400 100;
%       250 100 200;
%       250 250 200;
...
goal = bestGoalGA(source,goalBefore);
